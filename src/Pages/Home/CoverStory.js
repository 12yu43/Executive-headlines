                                    ...
                                    <div className="col-md-6 col-12 mb-20">

                                        {
                                            data.map((item, index) => {
                                                ...
                                                return (
                                                    <div className="post fashion-post post-separator-border" key={index}>
                                                        <div className="post-wrap">
                                                            <Link className="image" to={"/cover-story/" + item?.url}><img src={Endpoints.ImageUrl + item?.images} alt={item?.image_alt} /></Link>
                                                            <div className="content">
                                                                <h4 className="title"><Link to={"/cover-story/" + item?.url}>{item?.title}</Link></h4>
                                                ...
                                                return (
                                                    <div className="post post-small post-list fashion-post post-separator-border">
                                                        <div className="post-wrap">
                                                            <Link className="image" to={"/cover-story/" + item?.url}><img src={Endpoints.ImageUrl + item?.images} alt={item?.image_alt} /></Link>
                                                            <div className="content">
                                                                <h5 className="title"><Link to={"/cover-story/" + item?.url}>{item?.title.length > 45 ? item.title.substring(0, 45) + "..." : item.title}</Link></h5>
                                            ...
                                            return (
                                                <div className="post post-small post-list life-style-post post-separator-border col-lg-12 col-md-6 col-12 mt-2">
                                                    <div className="post-wrap">
                                                        <Link className="image" to={"/cover-story/" + item?.url}><img src={Endpoints.ImageUrl + item?.images} alt={item?.image_alt} /></Link>
                                                        <div className="content">
                                                            <h5 className="title"><Link to={"/cover-story/" + item?.url}>{item?.title.length > 40 ? item.title.substring(0, 40) + "..." : item.title}</Link></h5>
