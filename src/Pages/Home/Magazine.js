                ...
                <div className="row">
                    <div className="col-md-4">
                        <div className="mt-100 pt-50 text-white w-100 d-none d-md-block">
                            <h1 className="text-white ml-0">
                                <span style={{ color: "red", fontSize: "1.8rem" }}>Business Magazine</span>
                            </h1>
                        ...
                        <div className="mt-40 text-white w-100 d-md-none d-sm-block">
                            <h3 className="text-white mt-2 mb-2">
                                <span style={{ color: "red" }}>Business Magazine</span>
                            </h3>
                            <p style={{ fontSize: "20px" }} className="mt-2 mb-3">
                                Inspiring stories, instructive interviews and life-changing strategies.
                            </p>
                        </div>
                    </div>
